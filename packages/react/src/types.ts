import type { DedupeBehavior, ToastPosition, ToastRole } from '@twist-toast/core'
...
type ExtractComponentProps<TComponent> = TComponent extends ComponentType<infer TProps>
  ? TProps
  : never
...
type VariantMethod<TComponent extends ToastComponent<any>> =
  RequiredKeys<ExtractPayload<TComponent>> extends never
    ? (payload?: ExtractPayload<TComponent>, options?: ToastCallOptions) => string
    : (payload: ExtractPayload<TComponent>, options?: ToastCallOptions) => string
